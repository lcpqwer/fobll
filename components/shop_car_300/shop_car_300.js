// components/shop_car_300/shop_car_300.js
...
Component({
    ...
    methods: {
         ...
         */
        success() {
            let lastList = getApp().globalData.shop_car_300
            ...
            getApp().globalData.shop_car_300 = newList
        ...
        formatData(data) {
            ...
            for (let key in data) {
                ...
                data[key].supply_price = '300.00'
                data[key].int_price = '300'
                data[key].decimal = '00'
                arr.push(data[key])
            }
            return arr
        ...
        getShopCarWithPrice() {
            ...
            Request.Ajax(Url.getShopCarWithPrice(), params, 'POST').then(res => {
                console.log(res)
                if (res.code == 200) {
                    getApp().globalData.shop_car_bool['300.00'] = true
                    if (res.data instanceof Array) {
                        ...
                        getApp().globalData.shop_car_300 = _this.formatData(res.data).sort(_this.compare())
                        _this.getPageOne()
                    }
        ...
        getPageOne() {
            ...
            this.loadMore.setState('Loading')
            let ls = getApp().globalData.shop_car_300;
            console.log(ls)
        ...
        init() {
            ...
            if (getApp().globalData.shop_car_bool['300.00']) {
                console.log('已加载')
                if (ls.includes('300.00')) {
                    console.log('添加')
                    this.setData({
                        page: 1,
                        shopList: null
                    ...
                    this.getPageOne()
                    getApp().globalData.add_car_list = this.removeArray(ls, '300.00')
                }
            } else {
