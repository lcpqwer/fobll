...
Component({
    ...
    methods: {
         ...
         */
        success(){
            let lastList = getApp().globalData.shop_car_100
            ...
            getApp().globalData.shop_car_100 = newList
        ...
        formatData(data) {
            ...
            for (let key in data) {
                ...
                data[key].supply_price = '100.00'
                data[key].int_price = '100'
                data[key].decimal = '00'
                arr.push(data[key])
            }
            return arr
        ...
        getShopCarWithPrice() {
            ...
            Request.Ajax(Url.getShopCarWithPrice(), params, 'POST').then(res => {
                console.log(res)
                if (res.code == 200) {
                    getApp().globalData.shop_car_bool['100.00'] = true
                    if (res.data instanceof Array) {
                        ...
                        getApp().globalData.shop_car_100 = _this.formatData(res.data).sort(_this.compare())
                        _this.getPageOne()
                    }
        ...
        getPageOne() {
            ...
            this.loadMore.setState('Loading')
            let ls = getApp().globalData.shop_car_100;
            console.log(ls)
        ...
        init() {
            ...
            console.log(ls)
            if (getApp().globalData.shop_car_bool['100.00']) {
                if (ls.includes('100.00')) {
                    this.setData({
                        page: 1,
                        shopList: null
                    })
                    this.getPageOne()
                    getApp().globalData.add_car_list = this.removeArray(ls, '100.00')
                }
            } else {
