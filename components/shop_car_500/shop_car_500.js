// components/shop_car_500/shop_car_500.js
...
Component({
    ...
    methods: {
         ...
         */
        success() {
            let lastList = getApp().globalData.shop_car_500
            ...
            getApp().globalData.shop_car_500 = newList
        ...
        formatData(data) {
            ...
            for (let key in data) {
                ...
                data[key].supply_price = '500.00'
                data[key].int_price = '500'
                data[key].decimal = '00'
                arr.push(data[key])
            }
            return arr
        ...
        getShopCarWithPrice() {
            ...
            Request.Ajax(Url.getShopCarWithPrice(), params, 'POST').then(res => {
                console.log(res)
                if (res.code == 200) {
                    getApp().globalData.shop_car_bool['500.00'] = true
                    if (res.data instanceof Array) {
                        ...
                        getApp().globalData.shop_car_500 = _this.formatData(res.data).sort(_this.compare())
                        _this.getPageOne()
                    }
        ...
        getPageOne() {
            ...
            this.loadMore.setState('Loading')
            let ls = getApp().globalData.shop_car_500;
            console.log(ls)
        ...
        init() {
            ...
            console.log(ls)
            if (getApp().globalData.shop_car_bool['500.00']) {
                if (ls.includes('500.00')) {
                    this.setData({
                        page: 1,
                        shopList: null
                    })
                    this.getPageOne()
                    getApp().globalData.add_car_list = this.removeArray(ls, '500.00')
                }
            } else {
